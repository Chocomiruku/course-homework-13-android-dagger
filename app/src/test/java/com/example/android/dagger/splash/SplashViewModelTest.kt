...
class SplashViewModelTest {
    ...
    @Test
    fun `If the user is not registered then RegistrationActivity returns`() {
    ...
    @Test
    fun `If the user is registered but not logged in then LoginActivity returns`() {
    ...
    @Test
    fun `If the user is logged in then MainActivity returns`() {
